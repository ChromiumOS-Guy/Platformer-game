...
onready var score_label: Label = $Control3/GridContainer/Score
onready var gravite_label: Label = $Control3/GridContainer/gravite
...
onready var buutonthings2 = $button/'2'
...
func _ready() -> void:
	Enemy_die.volume_db = Database2.Sound
